...
//    request.setValue("multipart/form-data; boundary=\(access)", forHTTPHeaderField: "Content-Type")
...
func uploadPhotoAPI(route: String, method: String, boundary: String, body: Data?, completion: @escaping (Data?, ResponseErrors?) -> Void) {
